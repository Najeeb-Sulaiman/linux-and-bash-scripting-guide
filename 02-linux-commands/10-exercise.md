...
1. Create a folder called `practice_files` and navigate into it.

2. Create three files at once.

3. Add some text to each files.

4. Combine the contents of all three files into one new file called `all.txt`.

5. Display the content of the new file.

6. Show the first 2 lines of `all.txt`.

7. Open `all.txt` in a text editor.

8. Append a text to the `all.txt` file.
